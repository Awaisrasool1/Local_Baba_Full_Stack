...
const Theme = {
  ...
  icons: {
    ...
    add: require('../resource/images/add.png'),
    add_toCart_icon: require('../resource/images/add-to-cart.png'),
    minus: require('../resource/images/minus.png'),
    ...
    address: require('../resource/images/address.png'),
